...
class RawMaterialController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("store.rawmaterial.index")->with(compact('rawmaterials'));
    }
    ...
    public function create()
    {
       ...
       return view('store.rawmaterial.add' ,compact('addraws'));
    ...
    public function edit(string $id)
    {
        ...
        return view("store.rawmaterial.edit")->with(compact('rawmaterial'));
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->to(route('raw-material.index'));
    }
    ...
    public function search(Request $request){
        ...
        return view('store.rawmaterial.vieww',compact('searchQuery','records'));
    }
