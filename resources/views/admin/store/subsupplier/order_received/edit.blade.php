                        ...
                        <div class="row d-flex justify-content-center">
                           ...
                           <div class="border border-3 p-4 rounded">
                               ...
                               <div class="mb-4">
                                 ...
                                 <input type="integer" value="{{old('s_no', $order->s_no)}}" class="form-control @error('s_no') is-invalid @enderror" id="s_no" name="s_no">
                               ...
                               <div class="mb-4">
                                 ...
                                 <input type="integer" value="{{old('po_no',$order->po_no)}}" class="form-control @error('po_no') is-invalid @enderror" id="po_no" name="po_no">
                               ...
                               <div class="mb-4">
                                 ...
                                 <input type="test" value="{{old('dscp',$order->dscp)}}" class="form-control @error('dscp') is-invalid @enderror" id="dscp" name="dscp">
                                 <span class="text-danger">{{ $errors->first('dscp') }}</span>
									...
									<div class="mb-4">
										...
										<input type="integer" value="{{old('d_c',$order->d_c)}}" class="form-control @error('d_c') is-invalid @enderror" id="d_c" name="d_c">
										<span class="text-danger">{{ $errors->first('d_c') }}</span>
									</div>

							  <div class="mb-4">
								<label for="qty_in" class="form-label">Quantity In:</label>
								<input type="integer" value="{{old('qty_in',$order->qty_in)}}" class="form-control @error('qty_in') is-invalid @enderror" id="qty_in" name="qty_in">
