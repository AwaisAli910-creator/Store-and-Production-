    ...
    <!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<!--end breadcrumb-->
				<form method="POST" action="{{  route('adminraw-material.update', $rawmaterial	->id )}}">
    @method('PUT')
    @csrf
				<div class="card">
                        ...
                        <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
                               ...
                               <div class="mb-3">
                                 ...
                                 <input type="integer" value="{{old('s_no',$rawmaterial->s_no)}}" class="form-control @error('s_no') is-invalid @enderror"  id="s_no" name="s_no">
                              ...
                              <div class="mb-3">
                               ...
                               <textarea name="dscp" id="dscp" class="form-control @error('dscp') is-invalid @enderror" cols="5" rows="5"> {{old('dscp',$rawmaterial->dscp)}}</textarea>
                               ...
                               <div class="mb-3">
                                 ...
                                 <input type="integer" value="{{old('d_c',$rawmaterial->d_c)}}" class="form-control @error('d_c') is-invalid @enderror" id="d_c" name="d_c">
                               ...
                               <div class="mb-3">
                                ...
                                <input type="integer" value="{{old('qty_in',$rawmaterial->qty_in)}}" class="form-control @error('qty_in') is-invalid @enderror" id="qty_in" name="qty_in">
