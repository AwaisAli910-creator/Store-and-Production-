        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                  ...
                  <div class="ms-auto"><a href="{{route('adminraw-material.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Raw Materials</a></div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="{{route('adminraw-material.edit', $rawmaterial->id)}}" class=""><i class='bx bxs-edit'></i></a>
                                        <form method="post" action="{{route('adminraw-material.destroy', $rawmaterial->id)}}">
												@csrf
												{{method_field('DELETE')}}
