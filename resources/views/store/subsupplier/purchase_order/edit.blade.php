                               ...
                               <div class="mb-4">
                                 ...
                                 <span class="text-danger">{{ $errors->first('dscp') }}</span>
									...
									<div class="mb-4">
										...
										<input type="integer" value="{{old('d_c',$purchase->d_c)}}" class="form-control @error('d_c') is-invalid @enderror" id="d_c" name="d_c">
										<span class="text-danger">{{ $errors->first('d_c') }}</span>
									</div>

							  <div class="mb-4">
								<label for="qty_in" class="form-label">Quantity In:</label>
								<input type="integer" value="{{old('qty_in',$purchase->qty_in)}}" class="form-control @error('qty_in') is-invalid @enderror" id="qty_in" name="qty_in">
